...
/**
 * Интерфейс, содержащий методы для установки соединения с сайтом trello.com и получения от него пользовательских данных (информации о пользователе, его досках, списках и карточках).
 */
public interface ITrelloConnection
{
	/**
	 * Метод для установки соединения и получения данных о пользователе.
	 * @param a_key - ключ пользователя
	 * @param a_token - токен  пользователя
